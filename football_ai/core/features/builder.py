    ...
    def build_features(
        ...
        try:
            ...
            features: dict[str, float] = {
                ...
                "goals_diff": cls.calc_diff(
                    cls._pick(home_team_stats, "goals", "goals_scored", "avg_goals"),
                    cls._pick(away_team_stats, "goals", "goals_scored", "avg_goals"),
                ),
                "xg_diff": cls.calc_diff(cls._pick(home_team_stats, "xg", "avg_xg"), cls._pick(away_team_stats, "xg", "avg_xg")),
                "shots_diff": cls.calc_diff(
                    cls._pick(home_team_stats, "shots", "avg_shots"),
                    cls._pick(away_team_stats, "shots", "avg_shots"),
                ),
                "possession_diff": cls.calc_diff(
                    cls._pick(home_team_stats, "possession", "avg_possession"),
                    cls._pick(away_team_stats, "possession", "avg_possession"),
                ),
                # 3) HOME/AWAY
            ...
            return {k: cls._to_float(v) for k, v in features.items()}
        except Exception:
